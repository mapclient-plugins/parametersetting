...
from mapclientplugins.parametersettingstep.configuredialog import ConfigureDialog, extractParameters


class ParameterSettingStep(WorkflowStepMountPoint):
    '''
    ...
    def execute(self):
        ...
        self._portData0 = extractParameters(self._config)
